...
import { ADD_POST, apiUrl, DELETE_POST, FIND_POST, POSTS_LOADED_FAIL, POSTS_LOADED_SUCCESS, UPDATE_POST } from "./constants"
...
const PostContextProvider = ({ children }) => {
  ...
  const postContextData = { 
    postState, getPosts, addPost, findPost, deletePost, updatePost, 
